(function (global, factory) {
	...
	(global = typeof globalThis !== 'undefined' ? globalThis : global || self, global['publish/sidebar'] = factory());
	...
	function Publish(options) {
		...
		init(this, options);
		this.refs = {};
		this._state = assign(assign(this.store._init(["actions","publicVersion","metadata","id","publicUrl"]), data$4()), options.data);
	...
	function PublishSidebar(options) {
		...
		init(this, options);
		this._state = assign(assign(this.store._init(["user"]), data()), options.data);
