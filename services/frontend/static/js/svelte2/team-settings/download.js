(function (global, factory) {
	...
	typeof define === 'function' && define.amd ? define('svelte/team-settings/download', factory) :
	(global = typeof globalThis !== 'undefined' ? globalThis : global || self, global['team-settings/download'] = factory());
	...
	const file$2 = "node_modules/datawrapper/controls/HelpDisplay.html";
	...
	function create_if_block$1(component, ctx) {
		...
		var if_block1 = (ctx.type === 'upgrade-info') && create_if_block_1$1();
	...
	/* team-settings/tabs/Download.html generated by Svelte v2.16.1 */
	...
	const file = "team-settings/tabs/Download.html";

	function create_main_fragment(component, ctx) {
		var div1, div0, p0, text0_value = __('teams / download / p'), text0, text1, h3, text2_value = __('teams / download / data-localized' ), text2, text3, switchcontrol_updating = {}, text4, p1, text5_value = __('teams / download / data-localized / help' ), text5;

		var switchcontrol_initial_data = { label: __('teams / download / data-localized / switch') };
		if (ctx.settings.downloadDataLocalized !== void 0) {
			switchcontrol_initial_data.value = ctx.settings.downloadDataLocalized;
		...
		var switchcontrol = new SwitchControl({
			...
			_bind(changed, childState) {
				...
				if (!switchcontrol_updating.value && changed.value) {
					ctx.settings.downloadDataLocalized = childState.value;
		...
		return {
			c: function create() {
				...
				h3.className = "mb-4";
				addLoc(h3, file, 4, 8, 110);
				addLoc(p1, file, 10, 8, 349);
			...
			m: function mount(target, anchor) {
				...
				append(h3, text2);
				append(div0, text3);
				switchcontrol._mount(div0, null);
				append(div0, text4);
				append(div0, p1);
				append(p1, text5);
			},
			...
			p: function update(changed, _ctx) {
				...
				if (!switchcontrol_updating.value && changed.settings) {
					switchcontrol_changes.value = ctx.settings.downloadDataLocalized;
					switchcontrol_updating.value = ctx.settings.downloadDataLocalized !== void 0;
				}
	...
	function Download(options) {
		...
		if (!('settings' in this._state)) console.warn("<Download> was created without expected data property 'settings'");
		this._intro = true;
	...
	assign(Download.prototype, protoDev);

	Download.prototype._checkReadOnly = function _checkReadOnly(newState) {
	};
