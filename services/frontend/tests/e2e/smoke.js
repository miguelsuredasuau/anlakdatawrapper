...
describe('smoke', () => {
    ...
    it('creates a chart', async () => {
        ...
        await expect($uploadTextarea).toBeDisplayed();
...
Ukraine conflict between Russia and Western Countries;2;30;2;52;14`
        ...
        const $uploadProceed = await $('>>>#describe-proceed');
        ...
        await expect($visualizePreviewChart).toBeDisplayed(); // Check the chart type in the iframe.
        ...
        await expect($publishButton).toBeDisplayed();
        await $publishButton.click();
        const $publishUrl = await $('>>>#share-url');
        await expect($publishUrl).toBeDisplayed();
