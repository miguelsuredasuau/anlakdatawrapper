...
const eventList = {
    ...
    DELETE_CHART_ASSET: 'DELETE_CHART_ASSET',
    ...
    TEAM_SETTINGS_FILTER: 'TEAM_SETTINGS_FILTER',
    TEAM_OWNER_CHANGED: 'TEAM_OWNER_CHANGED',
    PUBLISH_CHART: 'PUBLISH_CHART',
    UNPUBLISH_CHART: 'UNPUBLISH_CHART',
    ...
    COMPUTED_THEME_DATA: 'COMPUTED_THEME_DATA',
    PLUGINS_LOADED: 'PLUGINS_LOADED',
    EXTERNAL_DATA_URL: 'EXTERNAL_DATA_URL',
    GET_PUBLIC_URL: 'GET_PUBLIC_URL',
    GET_NEXT_PUBLIC_URL: 'GET_NEXT_PUBLIC_URL',
    EXTEND_LIST_CHART_OPTIONS: 'EXTEND_LIST_CHART_OPTIONS',
    BASEMAPS_UPDATED: 'BASEMAPS_UPDATED'
};
