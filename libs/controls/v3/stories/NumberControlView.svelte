...
<NumberControl labelWidth="60px" label="with very long unit" unit="miles per gallon" min="0" max="100" bind:value />
<NumberControl labelWidth="60px" label="with help and unit" unit="px" help="Here you can get some help" min="0" max="100" bind:value />
<NumberControl labelWidth="80px" label="with help" help="Here you can get some help" min="0" max="100" bind:value />
...
<NumberControl labelWidth="80px" label="placeholder" min="0" max="100" placeholder="auto" bind:value />
...
<NumberControl labelWidth="80px" label="no slider with placeholder" slider={false} min="0" max="100" placeholder="auto" />
