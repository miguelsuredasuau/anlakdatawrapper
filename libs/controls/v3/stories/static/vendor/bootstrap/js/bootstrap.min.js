            ...
            backdrop: function (t) {
                ...
                if (this.isShown && this.options.backdrop) {
                    ...
                    (this.$backdrop = e('<div class="modal-backdrop ' + r + '" />').appendTo(document.body)),
                        this.$backdrop.click(
                            this.options.backdrop == 'static' ? e.proxy(this.$element[0].focus, this.$element[0]) : e.proxy(this.hide, this)
                        ),
        ...
        t.prototype = {
            ...
            applyPlacement: function (e, t) {
                ...
                n.offset(e).addClass(t).addClass('in'),
                    ...
                    t == 'bottom' || t == 'top'
                        ? ((u = 0),
                          e.left < 0 && ((u = e.left * -2), (e.left = 0), n.offset(e), (s = n[0].offsetWidth), (o = n[0].offsetHeight)),
            ...
            hide: function () {
                ...
                return (
                    n.removeClass('in'), e.support.transition && this.$tip.hasClass('fade') ? i() : n.detach(), this.$element.trigger('hidden'), this
                );
            },
            fixTitle: function () {
                var e = this.$element;
                    ...
                    (n = this.$body
                        ...
                        .map(function () {
                            var n = e(this),
                                ...
                                i = /^#\w/.test(r) && e(r);
                            return (
                                (i && i.length && [[i.position().top + (!e.isWindow(t.$scrollElement.get(0)) && t.$scrollElement.scrollTop()), r]]) ||
                                null
                            );
                        })
                        .sort(function (e, t) {
