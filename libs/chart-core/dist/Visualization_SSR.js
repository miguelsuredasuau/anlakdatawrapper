...
const Description = create_ssr_component(($$result, $$props, $$bindings, $$slots) => {
  ...
  if ($$props.props === void 0 && $$bindings.props && props !== void 0) $$bindings.props(props);
  let chart = props.chart;
  let description = clean(get(chart, "metadata.describe.intro"), allowedTags);
  return `${description}`;
...
const Source = create_ssr_component(($$result, $$props, $$bindings, $$slots) => {
  ...
  return `${sourceName ? `<span class="${"source-caption"}">${escape(caption)}:</span>
...
const Byline = create_ssr_component(($$result, $$props, $$bindings, $$slots) => {
  ...
  return `<span class="${"byline-caption"}">${escape(bylineCaption)}</span>
${escape(byline)}
...
const GetTheData = create_ssr_component(($$result, $$props, $$bindings, $$slots) => {
  ...
  return `${!hidden ? `<a this="${"dataLink"}" class="${"dw-data-link"}" aria-label="${escape(__(caption)) + ": " + escape(purifyHtml(chart.title, ""))}"${add_attribute("download", download, 0)}${add_attribute("target", externalData ? "_blank" : "_self", 0)}${add_attribute("href", externalData || href, 0)}>${escape(__(caption))}</a>` : ``}`;
...
const Embed = create_ssr_component(($$result, $$props, $$bindings, $$slots) => {
  ...
  let embedCode = get(chart, "metadata.publish.embed-codes.embed-method-responsive", "<!-- embed code will be here after publishing -->");
  return `<a href="${"#embed"}" class="${"chart-action-embed"}">${escape(embed.caption || __("Embed"))}</a>
${ ``}`;
...
const LogoInner = create_ssr_component(($$result, $$props, $$bindings, $$slots) => {
  ...
  return `${logo.imgSrc ? `<img${add_attribute("height", logo.height, 0)}${add_attribute("src", logo.imgSrc, 0)}${add_attribute("alt", theme.title, 0)}>` : ``}
...
function observeFonts(fontsJSON, typographyJSON) {
  ...
  const observers = [];
  fonts.forEach(font => {
    const obs = typeof font === 'string' ? new fontfaceobserver_standalone(font) : new fontfaceobserver_standalone(font.family, font.props);
...
var createCache = function createCache(options) {
  ...
  return cache;
};var emotionCache_esm=/*#__PURE__*/Object.freeze({__proto__:null,'default': createCache});/* eslint-disable */
...
};var emotionSerialize_esm=/*#__PURE__*/Object.freeze({__proto__:null,serializeStyles: serializeStyles});var isBrowser$1 = typeof document !== 'undefined';
...
};var emotionUtils_esm=/*#__PURE__*/Object.freeze({__proto__:null,getRegisteredStyles: getRegisteredStyles,insertStyles: insertStyles});var createCache$1 = getCjsExportFromNamespace(emotionCache_esm);var serialize = getCjsExportFromNamespace(emotionSerialize_esm);var utils = getCjsExportFromNamespace(emotionUtils_esm);var emotionCssCreateInstance_cjs_prod = createCommonjsModule(function (module, exports) {
...
var createCache__default = _interopDefault(createCache$1);
...
unwrapExports(emotionCssCreateInstance_cjs_prod);var emotionCssCreateInstance_cjs = createCommonjsModule(function (module) {

{
  module.exports = emotionCssCreateInstance_cjs_prod;
}
...
const Visualization = create_ssr_component(($$result, $$props, $$bindings, $$slots) => {
  ...
  const datasetName = `dataset.${get$1(chart.metadata, "data.json") ? "json" : "csv"}`;
  const coreBlocks = [{
    id: "headline",
    tag: "h1",
    region: "header",
...
`));
  ...
  async function run() {
    ...
    if (!dwChart.emotion) {
      dwChart.emotion = emotionCssCreateInstance_cjs.default({
  ...
  let ariaDescription = purifyHTML(get$1(chart, "metadata.describe.aria-description", ""), "<a><span><b><br><br/><i><strong><sup><sub><strike><u><em><tt><table><thead><tbody><tfoot><caption><colgroup><col><tr><td><th>");
  let customCSS = purifyHTML(get$1(chart, "metadata.publish.custom-css", ""), "");
  let blockProps = {
    __,
    purifyHtml: clean,
    get: get$1,
  ...
  let allBlocks = applyThemeBlockConfig([...coreBlocks, ...pluginBlocks], theme, blockProps);
   ...
   {
    {
      menu = get$1(theme, "data.options.menu", {});
    }
  }
